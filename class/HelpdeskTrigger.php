 ...
 * Remove this and extend DolibarrTriggers directly from interface_99_modHelpdesk_MyTrigger.class.php
...
if ($dolibarr_version[0] < 3 || ($dolibarr_version[0] == 3 && $dolibarr_version[1] < 7)) { // DOL_VERSION < 3.7
	 ...
	 * For Dolibarr < 3.7.
	 */
	abstract class HelpdeskTrigger
	{
	}
} else {
	/**
	 ...
	 * For Dolibarr >= 3.7
	 */
	abstract class HelpdeskTrigger extends DolibarrTriggers
	{
	}
}
