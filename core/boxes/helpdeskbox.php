 ...
 */
class HelpdeskBox extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "helpdeskbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "helpdesk@helpdesk";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		global $langs;
		$langs->load("boxes");
		$langs->load('helpdesk@helpdesk');

		parent::__construct($db, $param);

		$this->boxlabel = $langs->transnoentitiesnoconv("HelpdeskBox");
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/helpdesk/class/helpdesk.class.php";

		// Populate the head at runtime
		$text = $langs->trans("HelpdeskBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_helpdesk@helpdesk',
