...
/**
 * \defgroup    helpdesk    Helpdesk module
 * \brief       Helpdesk module descriptor.
 *
 * Put detailed description here.
 */

/**
 * \file        core/modules/modHelpdesk.class.php
 * \ingroup     helpdesk
...
/**
 * Description and activation class for module Helpdesk
 */
class modHelpdesk extends DolibarrModules
{
	...
	public $description = "Helpdesk module to manage all requests to any department.";

	/** @var string Module long description */
	public $descriptionlong = "This module allows to handle requests in any department of the company: Clients, Sales, IT, etc.";

	/**
	 * @var string Module editor name
	 * @since 4.0
	 */
	public $editor_name = "Multisistemas";

	/**
	 * @var string Module editor website
	 * @since 4.0
	 */
	public $editor_url = "http://www.multisitemas.com.sv";
	...
	public $const_name = 'MAIN_MODULE_HELPDESK';

	/**
	 * @var string Module logo
	 * Should be named object_helpdesk.png and store under helpdesk/img
	 */
	public $picto = 'helpdesk@helpdesk';

	/** @var array Define module parts */
	public $module_parts = array(
		/** @var bool Module ships triggers in helpdesk/core/triggers */
		'triggers' => true,
		/**
		 * @var bool Module ships login in helpdesk/core/login
		 * @todo: example
		 */
		'login' => false,
		/**
		...
		'menus' => false,
		/**
		 * @var bool Module ships theme in helpdesk/theme
		 * @todo example
		 */
		'theme' => false,
		/**
		 * @var bool Module shipped templates in helpdesk/core/tpl overload core ones
		 * @todo example
		 */
		'tpl' => false,
		/**
	...
	public $config_page_url = 'setup.php@helpdesk';
	...
	public $langfiles = array('helpdesk@helpdesk');
	...
	public function __construct($db)
	{
		...
		//$this->tabs = array(
			...
			//	'objecttype:+tabname1:Title1:langfile@helpdesk:$user->rights->helpdesk->read:/helpdesk/mynewtab1.php?id=__ID__',
			//	// To add another new tab identified by code tabname2
			//	'objecttype:+tabname2:Title2:langfile@helpdesk:$user->rights->othermodule->read:/helpdesk/mynewtab2.php?id=__ID__',
		...
		// Dictionaries
		if (! isset($conf->helpdesk->enabled)) {
			$conf->helpdesk=new stdClass();
			$conf->helpdesk->enabled = 0;
		}
		//$this->dictionaries = array();
		/* Example:
		  $this->dictionaries=array(
			  'langs'=>'helpdesk@helpdesk',
		...
		//	'titre'=>'Helpdesk top menu',
		// This menu's mainmenu ID
		//	'mainmenu'=>'helpdesk',
		// This menu's leftmenu ID
		//	'leftmenu'=>'helpdesk',
		//	'url'=>'/helpdesk/pagetop.php',
		//	// Lang file to use (without .lang) by module.
		//	// File must be in langs/code_CODE/ directory.
		//	'langs'=>'mylangfile',
		//	'position'=>100,
		//	// Define condition to show or hide menu entry.
		//	// Use '$conf->helpdesk->enabled' if entry must be visible if module is enabled.
		//	'enabled'=>'$conf->helpdesk->enabled',
		//	// Use 'perms'=>'$user->rights->helpdesk->level1->level2'
		...
		//	'type'=>'left',
		// Menu's title. FIXME: use a translation key
		//	'titre'=>'Helpdesk left menu',
		// This menu's mainmenu ID
		//	'mainmenu'=>'helpdesk',
		// This menu's leftmenu ID
		//	'leftmenu'=>'helpdesk',
		//	'url'=>'/helpdesk/pagelevel1.php',
		//	// Lang file to use (without .lang) by module.
		//	// File must be in langs/code_CODE/ directory.
		//	'langs'=>'mylangfile',
		//	'position'=>100,
	 ...
	 * and create data commands must be stored in directory /helpdesk/sql/
	...
	{
		return $this->_load_tables('/helpdesk/sql/');
	}
