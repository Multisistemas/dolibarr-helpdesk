...
/**
 * \file    test/functional/HelpdeskFunctionalTest.php
 * \ingroup helpdesk
 ...
 */
class HelpdeskFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	{
		$this->url('/custom/helpdesk/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('helpdesk/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/helpdesk/admin/about.php');
		$this->authenticate();
		return $this->assertContains('helpdesk/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testAboutPageRendersMarkdownReadme()
	{
		...
		return $this->assertEquals(
			'Dolibarr Module Template (aka Helpdesk)',
			$this->byTag('h1')->text(),
			"Readme title"
		);
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modHelpdesk_MyTrigger.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this
				->byXPath('//td[text()="interface_99_modHelpdesk_MyTrigger.class.php"]/following::img')
				->attribute('src'),
			"Trigger enabled"
		);
	}
