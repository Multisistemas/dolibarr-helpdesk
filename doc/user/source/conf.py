...
#
# html_title = 'Helpdesk vdevelopment'
...
latex_documents = [
    (master_doc, 'Mymodule.tex', 'Helpdesk Documentation',
...
man_pages = [
    (master_doc, 'helpdesk', 'Helpdesk Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Mymodule', 'Helpdesk Documentation',
