...
# TODO: use multiple word parameter, for example "My module is awesome" which should lead to "HelpdeskIsAwesome" and "helpdeskisawesome" so we can also fix language strings
